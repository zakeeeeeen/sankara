<div class="space-y-8">
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
            ...
            <h1 class="text-3xl font-extrabold tracking-tight text-slate-900">Tambah Paket Harga Baru</h1>
            <p class="mt-1 text-sm text-slate-500">Buat tier paket harga baru lengkap dengan fitur-fitur yang didapatkan</p>
        </div>
            ...
            <div class="grid gap-6 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <input
                        ...
                        wire:model="plan.tag"
                        class="mt-1.5 w-full rounded-2xl border border-slate-200 bg-slate-50/50 px-4 py-3 text-sm font-medium text-slate-900 outline-none focus:border-sky-500 focus:bg-white"
                        placeholder="Cocok untuk UMKM / Startup"
                    />
                </div>
                ...
                <div>
                    ...
                    <input
                        ...
                        placeholder="Mulai dari Rp 4.999.000"
                    />
                </div>
                ...
                <div class="sm:col-span-2">
                    ...
                    <textarea
                        ...
                        placeholder="Solusi lengkap untuk brand yang ingin langsung go digital..."
                    ></textarea>
                </div>
