...
@section('title', 'Kontak Kami - Sankara Tech')
@section('meta_description', 'Hubungi tim Sankara Tech untuk konsultasi proyek pembuatan website, software custom, aplikasi mobile, UI/UX, game, dan 3D asset.')
            ...
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="grid gap-12 lg:grid-cols-[1fr_1.2fr] lg:items-start">
                    <div class="reveal">
                        ...
                        <div class="mt-8 grid gap-4">
                            ...
                            <div class="agency-card flex items-start gap-4 p-5">
                                <div class="grid h-11 w-11 flex-none place-items-center rounded-2xl border border-sky-100 bg-[rgb(var(--agency-cyan)/0.12)] text-[rgb(var(--agency-cyan))]">
                                    <i class="fa-solid fa-envelope text-base" aria-hidden="true"></i>
                                </div>
                                <div class="min-w-0">
                ...
                <div class="mt-14 agency-card overflow-hidden p-0 reveal">
                    @if (filled($mapEmbedUrl))
                        <iframe
                            title="Lokasi Kantor Sankara Tech"
                            src="{{ $mapEmbedUrl }}"
                            width="100%"
                            height="400"
                            style="border:0;"
