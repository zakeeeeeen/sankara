    ...
    <form wire:submit="save" class="space-y-8">
        ...
        <div class="rounded-[2.5rem] border border-slate-200/80 bg-white/90 p-6 sm:p-8 shadow-xs backdrop-blur space-y-6">
            ...
            <div class="grid gap-6 sm:grid-cols-2">
                ...
                <div class="sm:col-span-2">
                    <label class="block text-xs font-bold text-slate-700 mb-1.5">Deskripsi Lengkap / Overview</label>
                    <x-rich-editor
                        wire:model="portfolioData.description"
                        placeholder="Tulis ringkasan dan rincian lengkap mengenai proyek ini..."
                        min-height="200px"
                    />
                    @error('portfolioData.description') <div class="mt-1 text-xs text-rose-600">{{ $message }}</div> @enderror
                </div>
            </div>
        </div>
                ...
                <div class="rounded-2xl border border-slate-100 bg-slate-50/50 p-5">
                    ...
                    <div class="mt-3 flex flex-col sm:flex-row items-start sm:items-center gap-4">
                        ...
                        @elseif ($existingCoverImage)
                            <div class="h-24 w-40 rounded-xl overflow-hidden border border-slate-200 shadow-sm shrink-0">
                                <img src="{{ $existingCoverImage }}" alt="Gambar Saat Ini" class="h-full w-full object-cover">
                            </div>
                        @endif
